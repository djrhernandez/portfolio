			...
			<React.Fragment>
				...
				<section className='coursework' id='coursework'>
					<div className='container-fluid py-5'>
						...
						<div class="card-deck px-5 py-3">
							<div class="card">
								<div class="card-body">
									<h5 class="card-title">Web Development</h5>
									<p class="card-text">PHP, JavaScript, HTML, CSS</p>
								</div>
							</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<p class="card-text">Oracle, SQL, PHP, Bootstrap</p>
								</div>
							</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<p class="card-text">C++, OpenGL, OpenAL, GLEW, Software Development Life Cycles</p>
								</div>
							</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<p class="card-text">Fuzzy Logic, Neural Networks, Genetic Algorithms/Programming</p>
								</div>
							</div>
						</div>
						...
						<div class="card-deck px-5 py-3">
							...
							<div class="card">
								<div class="card-body">
									<h5 class="card-title">Distributed & Parallel Computation</h5>
									<p class="card-text">Java, C++, Lightweight Java Game Library (LWJGL)</p>
								</div>
							</div>
							...
							<div class="card">
								<div class="card-body">
									...
									<p class="card-text">Intrusion Detection & Prevention Systems</p>
								</div>
							</div>

							<div class="card">
								<div class="card-body">
									<h5 class="card-title">Advanced Networks & Computer Security</h5>
									<p class="card-text">Kali Linux, Steganography, OpenSSL</p>
								</div>
							</div>
						</div>
					</div>
